...
{
    public partial class DescriptionLabelPrinterForm : Form
    {
       
        public DescriptionLabelPrinterForm()
        {
            InitializeComponent();
        }
 public List<Asset> _Assets = MainForm.Library.Assets;
        ...
        private void DescriptionLabelPrinterForm_Load(object sender, EventArgs e)
        {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                Avery5160StickerTemplate labels = new Avery5160StickerTemplate(list, pospos);
                pages.Add(labels);
